    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="input-group">
                <input class="form-control border-end-0 border rounded-pill" type="search" value="Search for an error" id="example-search-input">
                <span class="input-group-append">
                    <button class=" ml-2 btn btn-outline-secondary"id="search-btn" type="button">
                  ...
                  <div class="col-md-6">
                      <div class="cards py-3">
                        <div class="main-text2">
                              <h2>How to make a boostrap form using HTML and CSS</h2>
                          ...
                          <img class="cardsimg" src="images/banner5.avif">
                          <div><button class="btn btn-primary btn-3">DOWNLOAD SOURCE CODE</button></div>
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="cards py-3">
